// Must call init fist
dll_name="video_extension.dll";

EXT_VIDEO_INIT=external_define(dll_name,"init",dll_cdecl,ty_real,2,ty_string,ty_string);                        // Initialises the dll
...
EXT_VIDEO_RET=external_call(EXT_VIDEO_INIT,window_device(),"4c8aedd554b0fd9dd6c8574a207e26ee");
